...
//    }
    ...
    public AlgorithmGUI() {
        ...
        //btnMHo_vegen_1_3.addActionListener((ActionListener)new AlgorithmGUI.AlgorithmGUI$3(this));
       ...
       // btnMHo_vegen_1.addActionListener((ActionListener)new AlgorithmGUI.AlgorithmGUI$4(this));
      ...
      //  btnMHo_vegen_1_4.addActionListener((ActionListener)new AlgorithmGUI.AlgorithmGUI$5(this));
        ...
        //btnMHo_vegen_1_5.addActionListener((ActionListener)new AlgorithmGUI.AlgorithmGUI$6(this));
     ...
     //   btn_remove_decrypt_hill.addActionListener((ActionListener)new AlgorithmGUI.AlgorithmGUI$9(this));
       ...
       // btn_remove_result_key.addActionListener((ActionListener)new AlgorithmGUI.AlgorithmGUI$10(this));
        ...
        final JLabel lblNewLabel_2 = new JLabel("L\u01b0u \u00fd : Vi\u1ec7c t\u1ea1o key l\u00e0 ng\u1eabu nhi\u00ean n\u00ean m\u1ed9t s\u1ed1 tr\u01b0\u1eddng h\u1ee3p kh\u00f4ng tho\u1ea3 m\u00e3n \u0111i\u1ec1u ki\u1ec7n");
        lblNewLabel_2.setFont(new Font("Segoe UI", 0, 13));
        lblNewLabel_2.setBounds(158, 10, 496, 18);
        panel_17.add(lblNewLabel_2);
        final JLabel lblNewLabel_2_3 = new JLabel(" trong thu\u1eadt to\u00e1n Hill, v\u1eady h\u00e3y t\u1ea1o key nhi\u1ec1u l\u1ea7n \u0111\u1ebfn khi tho\u00e3 m\u00e3n !!");
     ...
     //   rabtn_text_twofish.addItemListener((ItemListener)new AlgorithmGUI.AlgorithmGUI$27(this));
       ...
       // btn_remove_hill_key_1_1_3.addActionListener((ActionListener)new AlgorithmGUI.AlgorithmGUI$33(this));
        ...
        (this.textField_keySize_blowfish = new JTextField()).setText(String.valueOf(this.blowfishController.getKeySize()));
    ...
    //    rabtn_text_blowfish.addItemListener((ItemListener)new AlgorithmGUI.AlgorithmGUI$34(this));
      ...
      //  rabtn_file_blowfish.addItemListener((ItemListener)new AlgorithmGUI.AlgorithmGUI$35(this));
        ...
        this.textField_privatekey_rsa.setBounds(100, 0, 370, 28);
        ...
        this.textField_publickey_rsa.setBounds(100, 0, 370, 28);
    ...
    public void handleVegenere(final ActionEvent e) {
        ...
        if (e.getSource() == this.btnNewButton__createKey_vegen) {
            this.vegenereController.handleCreateKey(this.textField_key_vegen, this.textField_keySize_vegen, (JFrame)this);
        }
        ...
        if (e.getSource() == this.btnMHo_vegen) {
            this.vegenereController.handleEncrypt(this.textArea_encrypt_vegen.getText(), this.textField_key_vegen, this.textArea_result_vegen, (JFrame)this);
            this.lblNewLabel_result_vegen.setText("K\u1ebft qu\u1ea3 m\u00e3 ho\u00e1");
        }
        if (e.getSource() == this.btnGiiM_vegen) {
            this.vegenereController.handleDecrypt(this.textArea_decrypt_vegen.getText(), this.textField_key_vegen, this.textArea_result_vegen, (JFrame)this);
    ...
    public void handleHill(final ActionEvent e) {
        ...
        if (e.getSource() == this.btnMHo_encrypt_hill) {
            this.hillController.hanldeEncrypt(this.textArea_encrypt_hill.getText(), keyFields, this.textArea_result_hill, (JFrame)this);
        }
        if (e.getSource() == this.btnGiiM_decrypt_hill) {
            this.hillController.hanldeDecrypt(this.textArea_decrypt_hill.getText(), keyFields, this.textArea_result_hill, (JFrame)this);
        }
    ...
    public void handleDes(final ActionEvent e) {
        ...
        if (e.getSource() == this.btn_encrypt_des) {
            if (this.desController.isCipherText()) {
                this.desController.hanldeEncryptText(this.textField_key_des, this.textArea_encrypt_des.getText(), this.textArea_result_des, (JFrame)this);
            }
            else {
                final String sourceFile = this.lb_filename_encrypt_des.getText();
                this.desController.hanldeEncryptFile(this.textField_key_des, sourceFile, this.textArea_result_des, (JFrame)this);
            }
        }
        if (e.getSource() == this.btn_decrypt_des) {
            if (this.desController.isCipherText()) {
                this.desController.hanldeDecryptText(this.textField_key_des, this.textArea_decrypt_des.getText(), this.textArea_result_des, (JFrame)this);
            }
            else {
                final String sourceFile = this.lb_filename_decrypt_des.getText();
                this.desController.hanldeDecryptFile(this.textField_key_des, sourceFile, this.textArea_result_des, (JFrame)this);
            }
        }
        if (e.getSource() == this.btn_save_result_des) {
            if (this.desController.isCipherText()) {
                ...
                this.generalController.hanldeSaveBytes((JFrame)this, this.desController.getInputBytes(), this.desController.getExtention());
            }
        }
    ...
    public void handleAes(final ActionEvent e) {
        ...
        if (e.getSource() == this.btn_encrypt_aes) {
            if (this.aesController.isCipherText()) {
                this.aesController.hanldeEncryptText(this.textField_key_aes, this.textArea_encrypt_aes.getText(), this.textArea_result_aes, (JFrame)this, keySize);
            }
            else {
                final String sourceFile = this.lb_filename_encrypt_aes.getText();
                this.aesController.hanldeEncryptFile(this.textField_key_aes, sourceFile, this.textArea_result_aes, (JFrame)this, keySize);
            }
        }
        if (e.getSource() == this.btn_decrypt_aes) {
            if (this.aesController.isCipherText()) {
                this.aesController.hanldeDecryptText(this.textField_key_aes, this.textArea_decrypt_aes.getText(), this.textArea_result_aes, (JFrame)this, keySize);
            }
            else {
                final String sourceFile = this.lb_filename_decrypt_aes.getText();
                this.aesController.hanldeDecryptFile(this.textField_key_aes, sourceFile, this.textArea_result_aes, (JFrame)this, keySize);
            }
        }
        if (e.getSource() == this.btn_save_result_aes) {
            if (this.aesController.isCipherText()) {
                ...
                this.generalController.hanldeSaveBytes((JFrame)this, this.aesController.getInputBytes(), this.aesController.getExtention());
            }
        }
    ...
    public void hanldeBlowfish(final ActionEvent e) {
        ...
        if (e.getSource() == this.btn_createKey_blowfish) {
            ...
            this.blowfishController.handleCreateKey(this.textField_key_blowfish, (JFrame)this, this.textField_keySize_blowfish.getText());
        }
        if (e.getSource() == this.btn_encrypt_blowfish) {
            if (this.blowfishController.isCipherText()) {
                this.blowfishController.hanldeEncryptText(this.textField_key_blowfish, this.textArea_encrypt_blowfish.getText(), this.textArea_result_blowfish, (JFrame)this, keySize);
            }
            else {
                final String sourceFile = this.lb_filename_encrypt_blowfish.getText();
                this.blowfishController.hanldeEncryptFile(this.textField_key_blowfish, sourceFile, this.textArea_result_blowfish, (JFrame)this, keySize);
            }
        }
        if (e.getSource() == this.btn_decrypt_blowfish) {
            if (this.blowfishController.isCipherText()) {
                this.blowfishController.hanldeDecryptText(this.textField_key_blowfish, this.textArea_decrypt_blowfish.getText(), this.textArea_result_blowfish, (JFrame)this, keySize);
            }
            else {
                final String sourceFile = this.lb_filename_decrypt_blowfish.getText();
                this.blowfishController.hanldeDecryptFile(this.textField_key_blowfish, sourceFile, this.textArea_result_blowfish, (JFrame)this, keySize);
            }
        }
        if (e.getSource() == this.btn_save_result_blowfish) {
            if (this.blowfishController.isCipherText()) {
                ...
                this.generalController.hanldeSaveBytes((JFrame)this, this.blowfishController.getInputBytes(), this.blowfishController.getExtention());
            }
        }
    ...
    public void hanldeTwofish(final ActionEvent e) {
        ...
        if (e.getSource() == this.btn_encrypt_twofish) {
            if (this.twofishController.isCipherText()) {
                this.twofishController.hanldeEncryptText(this.textField_key_twofish, this.textArea_encrypt_twofish.getText(), this.textArea_result_twofish, (JFrame)this);
            }
            else {
                final String sourceFile = this.lb_filename_encrypt_twofish.getText();
                this.twofishController.hanldeEncryptFile(this.textField_key_twofish, sourceFile, this.textArea_result_twofish, (JFrame)this);
            }
        }
        if (e.getSource() == this.btn_decrypt_twofish) {
            if (this.twofishController.isCipherText()) {
                this.twofishController.hanldeDecryptText(this.textField_key_twofish, this.textArea_decrypt_twofish.getText(), this.textArea_result_twofish, (JFrame)this);
            }
            else {
                final String sourceFile = this.lb_filename_decrypt_twofish.getText();
                this.twofishController.hanldeDecryptFile(this.textField_key_twofish, sourceFile, this.textArea_result_twofish, (JFrame)this);
            }
        }
        ...
        if (e.getSource() == this.btn_save_result_twofish) {
            if (this.twofishController.isCipherText()) {
                ...
                this.generalController.hanldeSaveBytes((JFrame)this, this.twofishController.getInputBytes(), this.twofishController.getExtention());
            }
        }
    ...
    public void handleRSA(final ActionEvent e) {
        ...
        if (e.getSource() == this.btn_createKey_rsa) {
            this.rsaController.handleCreateKey(this.textField_privatekey_rsa, this.textField_publickey_rsa, (JFrame)this, keySize);
        }
        if (e.getSource() == this.btn_encrypt_rsa) {
            if (this.rsaController.isCipherText()) {
                this.rsaController.handleEncryptText(this.textArea_result_rsa, this.textArea_encrypt_rsa.getText(), (JFrame)this);
            }
            else {
                this.rsaController.handleEncryptFile(this.lb_filename_encrypt_rsa.getText(), (JFrame)this);
            }
        }
        if (e.getSource() == this.btn_decrypt_rsa) {
            if (this.rsaController.isCipherText()) {
                this.rsaController.handleDecryptText(this.textArea_result_rsa, this.textArea_decrypt_rsa.getText(), (JFrame)this);
            }
            else {
                this.rsaController.handleDecryptFile(this.lb_filename_decrypt_rsa.getText(), (JFrame)this);
            }
        }
    ...
    public void handleMd5(final ActionEvent e) {
        if (e.getSource() == this.btn_hash_md5) {
            ...
            if (this.hashController.isHashTextMd5()) {
                this.hashController.handleHashText(this.textArea_hash_md5.getText(), this.textArea_result_md5, (JFrame)this);
            }
            else {
                this.hashController.handleHashFile(this.lb_filename_md5.getText(), this.textArea_result_md5, (JFrame)this);
            }
        }
    ...
    public void hanldSha(final ActionEvent e) {
        if (e.getSource() == this.btn_hash_sha) {
            ...
            if (this.hashController.isHashTextSha()) {
                this.hashController.handleHashText(this.textArea_hash_sha.getText(), this.textArea_result_sha, (JFrame)this);
            }
            else {
                this.hashController.handleHashFile(this.lb_filename_sha.getText(), this.textArea_result_sha, (JFrame)this);
            }
        }
